Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/goopi/Foursquare-API-v2"
  s.screenshots  = "https://raw.github.com/goopi/Foursquare-API-v2/master/img/photo2.PNG"
  s.license      = 'MIT'
  s.author       = { "Constantine Fry" => "constantine.fry@gmail.com" }
  s.source       = { :git => "https://github.com/goopi/Foursquare-API-v2.git", :tag => "1.4.5" }
  s.platform     = :ios, '5.0'
